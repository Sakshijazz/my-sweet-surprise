...
const LittleNotePage = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-soft flex flex-col items-center justify-center p-6 relative overflow-hidden transition-all duration-600 ${isExiting ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
      <Sparkles count={15} />
        ...
        <div className="mt-8 z-10 animate-fade-slide-up max-w-sm">
          <div className="bg-pastel-cream rounded-3xl p-6 shadow-glow">
            <div className="font-handwritten text-lg text-foreground leading-relaxed">
              ...
              <p className="mt-4 text-sm text-heart-pink italic">
